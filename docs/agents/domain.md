...
This repo's `docs/adr/` is already populated, so that step has real material: start at
[`docs/adr/README.md`](../adr/README.md), which indexes every ADR with a one-line title, and read the
ones covering your area rather than the whole directory.
