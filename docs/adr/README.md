...
- [ADR 0001: Possession-Based Homeowner Verification](./0001-possession-based-homeowner-verification.md) — identity model partially superseded by ADR 0022
- [ADR 0002: Tiered Content and Document Storage](./0002-tiered-content-and-document-storage.md)
- [ADR 0003: Board Role Management and Bootstrap](./0003-board-role-management-and-bootstrap.md) — access model partially superseded by ADR 0022
...
- [ADR 0006: People-per-Home Roster](./0006-people-per-home-roster.md) — roster model partially superseded by ADR 0022
...
- [ADR 0012: Board Record Modeled as Structured Rows, Separate from Auth Users](./0012-board-record-as-structured-rows.md) — identity model partially superseded by ADR 0022
...
- [ADR 0019: Homeowner Writes Are Official-Mode Gated](./0019-homeowner-writes-official-mode-gate.md) — lot-control model partially superseded by ADR 0022
